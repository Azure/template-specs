...
1. Download the [AzTemplateSpecsPrivatePreview](https://github.com/Azure/template-specs/releases/download/0.1.1/AzTemplateSpecsPrivatePreview.zip) zip package from the Releases page in this repo.
